...
# Aqui iremos manipular a entrada  de dados do usuario
def entrada_dados():
    print("\n##### Entrada de Dados #######")
...
def deletar_dados():
    print("\n##### Deleção de Dados #####")
    cultura = input("Digite a cultura para deletar os dados (Berinjela ou Cana): ").lower()
...
def menu_principal():
    while True:
        ...
        print("2. Saída de Dados de Plantio")
